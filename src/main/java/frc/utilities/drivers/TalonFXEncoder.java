 ...
 * Add your docs here.
 */
public class TalonFXEncoder extends WPI_TalonFX {
	...
	public TalonFXEncoder(int deviceId, double encoderTicksToWorld, FeedbackDevice feedbackDevice) {
		this(deviceId, encoderTicksToWorld, false, feedbackDevice);
	}

	public TalonFXEncoder(int deviceNumber, double encoderTicksToWorld, boolean isRight, FeedbackDevice feedbackDevice) {
		super(deviceNumber);
